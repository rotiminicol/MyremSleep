                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white/95 backdrop-blur-md border border-gray-100 shadow-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 pointer-events-auto">
                            <div className="flex-1 text-center md:text-left">
                                <h3 className="text-lg font-serif text-gray-900 mb-2">Cookie Settings</h3>
                            ...
                            <div className="flex items-center gap-4 w-full md:w-auto">
                                <button
                                    ...
                                    className="flex-1 md:flex-none px-8 py-3 bg-transparent border border-gray-200 text-gray-600 text-[10px] sm:text-xs font-bold tracking-[0.2em] uppercase hover:bg-gray-50 transition-all duration-300"
                                >
                                    Decline
                                </button>
                                <button
                                    onClick={handleAccept}
                                    className="flex-1 md:flex-none px-8 py-3 bg-[#1a1a1a] text-white text-[10px] sm:text-xs font-bold tracking-[0.2em] uppercase hover:bg-black transition-all duration-300 shadow-lg shadow-black/5"
                                >
                                    Accept
                                </button>
                            </div>
