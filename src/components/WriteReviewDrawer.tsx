      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-full max-w-md bg-[#F2EDE8] shadow-xl z-50 flex flex-col"
          >
            ...
            {/* Footer */}
            <div className="border-t border-[#e0dbd5] px-6 py-4 bg-[#F2EDE8] flex items-center justify-between flex-shrink-0">
