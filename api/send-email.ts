...
@myremsleepclub
© 2024 REMSLEEP. ALL RIGHTS RESERVED.`,
                html: `
                <!DOCTYPE html>
                <html lang="en">
                <head>
                ...
                <body style="margin: 0; padding: 0; background-color: #f5f1ed;">
                    <center style="width: 100%; background-color: #f5f1ed;">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f5f1ed">
                            <tr>
                                <td align="center" style="padding: 60px 20px;">
                                    ...
                                    <td>
                                    <![endif]-->
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 540px; text-align: center; font-family: 'Montserrat', Helvetica, Arial, sans-serif; color: #2d2a26;">
                                        <!-- Logo -->
                                        <tr>
                                        ...
                                        <!-- Header -->
                                        <tr>
                                            <td style="font-family: 'Playfair Display', serif; font-size: 38px; color: #1a1a1a; padding-bottom: 35px; font-weight: 400; font-style: italic; line-height: 1.2; letter-spacing: -0.5px;">
                                                Rest is not a routine.<br/>It is a ritual.
                                            </td>
                                        </tr>
                                        <!-- Content -->
                                        <tr>
                                            <td style="font-size: 15px; line-height: 1.8; color: #4a4a4a; font-weight: 300; letter-spacing: 0.2px; padding-bottom: 30px;">
                                                We have processed your request. This email confirms your unsubscription from our journal. 
                                                While we are sorry to see you go, we respect your quiet space.
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center" style="padding-bottom: 50px;">
                                                <div style="height: 1px; background-color: #e8e3dc; width: 60px;"></div>
                                            </td>
                                        </tr>
                                        <!-- CTA -->
                                        <tr>
                                            <td style="padding-bottom: 20px;">
                                                <a href="https://www.myremsleep.com" style="color: #2d2a26; text-decoration: none; font-weight: 500; border-bottom: 1px solid #2d2a26; padding-bottom: 2px; font-size: 13px; letter-spacing: 1px; text-transform: uppercase;">Return to the ritual</a>
                                            </td>
                                        </tr>
                                        <!-- Footer -->
                                        <tr>
                                            <td style="padding-top: 30px; border-top: 1px solid #e8e3dc;">
                                                <a href="https://www.instagram.com/myremsleepclub/" style="text-decoration: none; display: inline-block; margin-top: 25px;">
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                                        <tr>
                                                            ...
                                                            <td style="font-size: 12px; color: #888; letter-spacing: 1px; margin-left: 8px; text-transform: uppercase; padding-left: 8px;">
                                                                @myremsleepclub
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </a>
                                                <div style="font-size: 11px; color: #aaa; margin-top: 30px; letter-spacing: 0.5px;">&copy; 2024 REMSLEEP. ALL RIGHTS RESERVED.</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <!--[if (gte mso 9)|(IE)]>
...
In a world that rarely slows down, sleep becomes recovery. Renewal. A quiet reset where new dreams take shape.
                ...
                html: `
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            table { border-spacing: 0 !important; border-collapse: collapse !important; table-layout: fixed !important; margin: 0 auto !important; }
                            img { -ms-interpolation-mode: bicubic; display: block; border: 0; }
                            .external-link { color: inherit !important; text-decoration: none !important; }
                            
                            @media screen and (max-width: 600px) {
                                .container { width: 100% !important; padding-left: 15px !important; padding-right: 15px !important; }
                                .outer-padding { padding: 40px 10px !important; }
                                .editorial-statement { font-size: 28px !important; }
                            }
                        </style>
                    </head>
                    <body style="margin: 0; padding: 0; background-color: #F5F1ED;">
                        <center style="width: 100%; background-color: #F5F1ED;">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#F5F1ED">
                                <tr>
                                    <td align="center" class="outer-padding" style="padding: 80px 20px;">
                                        <!--[if (gte mso 9)|(IE)]>
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="520" align="center">
                                        <tr>
                                        <td>
                                        <![endif]-->
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 520px; font-family: 'Montserrat', Helvetica, Arial, sans-serif; color: #2D2A26; line-height: 1.8; text-align: center;">
                                            <!-- Logo -->
                                            <tr>
                                            ...
                                            <!-- Header -->
                                            <tr>
                                                <td class="editorial-statement" style="font-family: 'Playfair Display', serif; font-size: 32px; font-style: italic; color: #1a1a1a; padding-bottom: 45px; line-height: 1.2; letter-spacing: -0.5px;">
                                                    Welcome to REMsleep
                                                </td>
                                            </tr>
                                            ...
                                            <!-- Greeting -->
                                            <tr>
                                                <td style="font-size: 15px; font-weight: 300; letter-spacing: 0.2px; padding-bottom: 25px;">
                                                    Hello ${name || 'there'},
                                                </td>
                                            </tr>
                                            ...
                                            <!-- Signature Insight -->
                                            <tr>
                                                <td style="font-family: 'Playfair Display', serif; font-style: italic; font-size: 18px; color: #1a1a1a; padding: 10px 0 45px 0;">
                                                    Rest. Renew. Awaken new dreams.
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" style="padding-bottom: 60px;">
                                                    <div style="border-top: 1px solid #e8e3dc; width: 60px;"></div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 60px;">
                                                    ...
                                                    <div style="font-style: italic; font-size: 15px; font-weight: 300; padding-bottom: 15px;">
                                                        &bull; Reply with one word:<br/>What do you want your bedroom to feel like this season?
                                                    </div>
                                                    <div style="font-size: 11px; color: #888; letter-spacing: 2px; text-transform: uppercase; padding-bottom: 15px;">
                                                        Calm &bull; Cosy &bull; Restored &bull; Inspired
                                                    </div>
                                                    <div style="font-size: 15px; font-weight: 300;">I read every reply.</div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 70px;">
                                                    <div style="font-weight: 400; text-transform: uppercase; letter-spacing: 1px; font-size: 12px; padding-bottom: 10px;">With love,</div>
                                                    <div style="font-family: 'Playfair Display', serif; font-size: 28px; font-style: italic; color: #1a1a1a; padding-bottom: 5px;">Kiki</div>
                                                    <div style="font-size: 11px; color: #888; text-transform: uppercase; letter-spacing: 1px;">Founder, REMsleep</div>
                                                </td>
                                            </tr>

                                            <!-- P.S. -->
                                            <tr>
                                                <td style="font-size: 12px; color: #888; font-style: italic; padding-bottom: 80px;">
                                            ...
                                            <!-- Footer -->
                                            <tr>
                                                <td style="border-top: 1px solid #e8e3dc; padding-top: 40px;">
                                                    <a href="https://www.instagram.com/myremsleepclub/" style="text-decoration: none; display: inline-block; padding-bottom: 20px;">
                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                                            <tr>
                                                                ...
                                                                <td style="font-size: 11px; color: #888; letter-spacing: 1px; padding-left: 8px; text-transform: uppercase;">
                                                                    @myremsleepclub
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </a>
                                                    <div style="font-size: 10px; color: #aaa; letter-spacing: 1px; text-transform: uppercase; padding-bottom: 15px;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                <tr>
                                    <td align="center" style="padding: 40px 20px;">
                                        ...
                                        <td>
                                        <![endif]-->
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; font-family: 'Montserrat', Arial, sans-serif; color: #2d2a26; text-align: left;">
                                            <tr>
                                                <td style="padding-bottom: 10px; border-bottom: 2px solid #e8e3dc;">
                                                    <h2 style="margin: 0; color: #2d2a26;">New Questionnaire Submission</h2>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td bgcolor="#f9f8f6" style="padding: 20px; border-radius: 4px;">
                                                    <h3 style="margin-top: 0;">Responses:</h3>
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr><td style="padding-bottom: 10px;"><strong>Bed Size:</strong> ${answers?.bedSize || 'Not specified'}</td></tr>
                                                        <tr><td style="padding-bottom: 10px;"><strong>Colors:</strong> ${answers?.colors?.join(', ') || 'Not specified'} ${answers?.colorOther ? `(Other: ${answers.colorOther})` : ''}</td></tr>
                                                        <tr><td style="padding-bottom: 10px;"><strong>Feel:</strong> ${answers?.feel || 'Not specified'}</td></tr>
                                                        <tr><td style="padding-bottom: 10px;"><strong>Priority:</strong> ${answers?.priority || 'Not specified'}</td></tr>
                                                        <tr><td style="padding-bottom: 10px;"><strong>Bed Feeling:</strong> ${answers?.bedFeeling || 'Not specified'}</td></tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="center" style="padding: 40px 20px;">
                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; font-family: 'Montserrat', Arial, sans-serif; color: #2d2a26; text-align: left;">
                                            <tr>
                                                <td style="padding-bottom: 10px; border-bottom: 2px solid #e8e3dc;">
                                                    <h2 style="margin: 0; color: #2d2a26;">New Contact Form Submission</h2>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#f9f8f6" style="padding: 20px; border-radius: 4px; border: 1px solid #e8e3dc; margin: 20px 0;">
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr><td style="padding-bottom: 10px;"><strong>From:</strong> ${name}</td></tr>
                                                        <tr><td style="padding-bottom: 10px;"><strong>Email:</strong> <a href="mailto:${email}">${email}</a></td></tr>
                                                        <tr><td><strong>Subject:</strong> ${userSubject}</td></tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="border-top: 1px solid #e8e3dc; padding-top: 15px; color: #666; font-size: 12px;">
                                                    <p style="margin: 0;">This message was sent from the REMsleep website contact form.</p>
                                                </td>
                                            </tr>
                                        </table>
                                        <!--[if (gte mso 9)|(IE)]>
                ...
                html: `
                    ...
                    <body style="margin: 0; padding: 0; background-color: #f5f1ed;">
                        <center style="width: 100%; background-color: #f5f1ed;">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f5f1ed">
                                <tr>
                                    <td align="center" class="outer-padding" style="padding: 60px 20px;">
                                        <!--[if (gte mso 9)|(IE)]>
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="580" align="center">
                                        <tr>
                                        <td>
                                        <![endif]-->
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 580px; text-align: left; font-family: 'Montserrat', Helvetica, Arial, sans-serif; color: #4a4a4a; line-height: 1.8;">
                                            <!-- Logo -->
                                            <tr>
                                                <td align="center" style="padding-bottom: 50px;">
                                                    <img src="https://www.myremsleep.com/logo5.png" alt="REMsleep" width="160" style="margin: 0 auto; height: auto; opacity: 0.9;" />
                                            ...
                                            <!-- Greeting -->
                                            <tr>
                                                <td style="font-family: 'Playfair Display', serif; font-size: 28px; font-style: italic; color: #1a1a1a; padding-bottom: 30px;">
                                                    Hi ${name || 'there'},
                                                </td>
                                            </tr>
                                            <!-- Content -->
                                            <tr>
                                                <td style="font-weight: 300; padding-bottom: 20px;">
                                                    Thank you for reaching out to us. We have received your message and will be in touch with you shortly.
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="font-weight: 300; padding-bottom: 25px;">
                                                    In the meantime, you may find the information you need in our collection notes:
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 45px;">
                                                    <a href="https://www.myremsleep.com/faq" style="color: #2d2a26; text-decoration: none; border-bottom: 1px solid #2d2a26; padding-bottom: 2px; font-weight: 500; font-size: 13px; letter-spacing: 1px; text-transform: uppercase;">View our FAQs</a>
                                                </td>
                                            </tr>
                                            <!-- Divider -->
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="font-family: 'Playfair Display', serif; font-size: 18px; font-style: italic; color: #1a1a1a; padding-bottom: 25px;">Rest. Renew. Awaken new dreams.</div>
                                                    <div style="font-weight: 400; letter-spacing: 1px; text-transform: uppercase; font-size: 12px; padding-bottom: 5px;">With care,</div>
                                                    <div style="font-weight: 500; padding-bottom: 35px;">REMsleep Team</div>
                                                    
                                                    <div style="border-top: 1px solid #e8e3dc; padding-top: 30px;">
                                                        <a href="https://www.instagram.com/myremsleepclub/" style="text-decoration: none; color: #2d2a26; font-size: 12px; letter-spacing: 1px; text-transform: uppercase; font-weight: 500;">
